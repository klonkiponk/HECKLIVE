...
function switchOrderUp(){
	
}
function switchOrderDown(){
...
$(document).ready(function() {   
	...
	$("body").on("click","span.editAnExitingPostButton",function(){
